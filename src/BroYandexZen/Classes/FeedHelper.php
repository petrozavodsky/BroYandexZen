...
class FeedHelper
{
    ...
    public function __construct($categories)
    {
        ...
        add_action("BroYandexZenFeedFields_after", [$this, 'author'], 11, 1);
        add_action("BroYandexZenFeedFields_after", [$this, 'category'], 12, 1);
        add_action("BroYandexZenFeedFields_after", [$this, 'enclosure'], 13, 1);
        add_action("BroYandexZenFeedFields_after", [$this, 'fulltext'], 13, 1);
     ...
     * @return string
     */
    public function fulltext($post, $show = true)
    {

        $content = $post->post_content;
        $content = do_shortcode($content);

        $content = $this->fulltext_helper($content);
     ...
     * @return string
     */
    public function category($post, $show = true)
    {
     ...
     * @return string
     */
    public function author($post, $show = true)
    {
     ...
     * @return string|bool
     */
    public function enclosure($post, $show = true)
    {
